...
export const getStatus = async()=>{
    let res = await fetch("http://172.16.101.146:5328/requests")
...
export const  getNotInTime = async () =>{
    let res = await fetch("http://172.16.101.146:5328/requests?date_request")
    let data = await res.json();
    let dataUpdate = [];
    data.forEach(val => {
    ...
    export const getTwoDaysBefore = async () =>{
        let res = await fetch("http://172.16.101.146:5328/requests?status=Entregado")
        let data = await res.json();
        let dataUpdate = [];
        data.forEach(val => {
...
export const rejectedRequestsIn2009 = async()=>{
    let res = await fetch("http://172.16.101.146:5328/requests?status=Rechazado")
    let data = await res.json();
