import { 
    getSpainClients, 
    getAllMadridClientsWith11And33Code,getClientsName,getClients,getClientsNoPay,
} from "../module/clients.js";
import {
    getAllEmployeesWithBossAndCodeServer,getBossFullNameAndEmail,getAllNotSellManager,getSalesManager
...
export class Mycard extends HTMLElement{
    ...
    async getSpainClientsAndRepresentative11Or30Design(){
        let data = await getSpainClientsAndRepresentative11Or30();
        data.forEach(val => {
    ...
    attributeChangedCallback(name, old, now) {
        ...
        if(name=="logic" && now=="client_16") this.getSpainClientsAndRepresentative11Or30Design()
